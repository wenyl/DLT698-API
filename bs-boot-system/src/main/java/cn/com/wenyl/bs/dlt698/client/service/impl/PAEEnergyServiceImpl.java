...
import cn.com.wenyl.bs.dlt698.client.service.PAEEnergyService;
...
public class PAEEnergyServiceImpl implements PAEEnergyService {
    ...
    public Object getPAEEnergy(@CarbonDeviceAddress String carbonDeviceAddress) throws ExecutionException, InterruptedException, TimeoutException, JSONException, InvocationTargetException, NoSuchMethodException, InstantiationException, IllegalAccessException {
